...
const URL = 'https://api.themoviedb.org/3/movie/popular?language=en-US&page=1&with_watch_monetization_types=flatrate&sort_by=popularity.desc&include_adult=false&include_video=false';
...
const fetchPopularMovies = createAsyncThunk("/popularMoviesSlice", () => {
    return (
